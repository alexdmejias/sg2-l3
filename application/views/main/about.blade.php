		...
		<div  class="grid_48">
			<div id="content" class="grid_44 push_2"><!--actual content-->
				...
				<div id="main-left" class="grid_20 push_1 alpha"><!--Left main content -->
					<h1>Who are we?</h1>
					<p>We are a team of students headed by <a href="http://alex-mejias.com">Alex Mejias</a> from Queens Collge, who has realized that for a variety of reasons, people are not concious of the enviroment and their impact on it. The team behind Greenserve has realized that in order to persuade people that there are benefits to going "green", we have crated Greenserve.</p>
